...
public class CandidateSolution implements Comparable<CandidateSolution> {
     ...
     *
     * @param baseCity
     * @param visitingCities the route for the TSP
     */
     ...
     * parent)
     *
     * @param childRoute  route to be filled with crossing parent
     * @param parentRoute crossing parent of the child
     * @param cutIndex    index where both parent routes were cut
     */
